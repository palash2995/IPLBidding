...
/**
 * Servlet implementation class TeamBidEntry
 */
public class TeamBidEntry extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			if(!playerId.equals(""))
			{
				if((diff-time)<150000) response.sendRedirect("/iplBidding/bidFramework.jsp?");
			}
		}catch (Exception e) 
		{ 
